...
<html lang="en">
	...
	<script type="text/javascript">
            ...
            {/*
                if(value=="PRODUCCION" || value==true)
                {
                    // habilitamos
                ...
                }else if(value!="PRODUCCION" || value==false){
                    // deshabilitamos
		...
		<div class="container">
			<div class="table-wrapper"id="box">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-8"><h2><b>Agregar registro de produccion diaria por fabrica.</b></h2></div>
						<div class="col-sm-4">
							<script type="text/javascript">
				...
				<div class="row">
					<form method="post" id="form1" name="form1">
						<div class="col-md-6">
							...
							<input list="listat" type="text" class='form-control' name="tipo" id="tipo" autocomplete="off" maxlength="10" placeholder="Ingresa el tipo." required>
							
						</div>
						<div class="col-md-6" id="selectcodigos">
							<label>Codigo</label>
								<datalist id="lista1">
									<?php
								...
								<input list="lista1" type="text" name="codigo" id="codigo" class='form-control' autocomplete="off" maxlength="10" placeholder="Ingresa el codigo.">
							</select>					
                        </div>
                        <script type="text/javascript"> $("#selectcodigos").hide(); </script>
						...
						<div class="col-md-6">
                            ...
                            <input list="listad" type="text" class='form-control' name="departamento" id="departamento" autocomplete="off" maxlength="10" placeholder="Ingresa el departamento." required>
						</div>

						<div class="col-md-6" id="selectdefectos">
									
                        </div>
                        <script type="text/javascript"> $("#selectdefectos").hide(); </script>
						<div class="col-md-6" id="selectestilos">
							<label>Estilo</label>
							<datalist id="lista2">
							...
							<input list="lista2" class='form-control' id="estilo" name="estilo" placeholder="Ingresa el estilo" autocomplete="off">
                        </div>
                        <script type="text/javascript"> $("#selectestilos").hide(); </script>
						<!--<div class="col-md-6" id="selectlinea">
									
						</div>-->
						<div class="col-md-6" id="selectcolor">
							<label>Color</label>
							<input type="text" name="color" id="color" class='form-control' autocomplete="off" maxlength="50" placeholder="Ingresa el color.">
                        </div>
                        <script type="text/javascript"> $("#selectcolor").hide(); </script>
						<div class="col-md-6" id="selectpiel">
							<label>Piel</label>
							<input type="text" name="piel" id="piel" class='form-control' autocomplete="off" maxlength="50" placeholder="Ingresa la piel.">
                        </div>
                        <script type="text/javascript"> $("#selectpiel").hide(); </script>
						<div class="col-md-6" id="selecttalla">
							<label>Talla</label>
							<input type="text" name="talla" id="talla" class='form-control' autocomplete="off" maxlength="10" placeholder="Ingresa la talla.">
                        </div>
                        <script type="text/javascript"> $("#selecttalla").hide(); </script>
						<div class="col-md-6">
							<datalist id="lista3">
								<?php
									$bandas = new Database();
