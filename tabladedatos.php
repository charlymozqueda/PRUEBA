...
<body style="background-color:#f7efed">
    ...
    <div>
        ...
        <a href="index.php" class="btncerr" onclick="return Confirmacionsalir()">Regresar</a>
        ...
        <table class="table" id="datos" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="delete.php?id=<?php echo $id;?>" class="delete" title="Eliminar" data-toggle="tooltip" onclick="return Confirmacion()"><i class="material-icons">&#xE872;</i></a>
                    </td>
                </tr>
                <?php
                    }
