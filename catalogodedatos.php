...
<body >
    <header>
        <h2 class="header"><b>Catalogo de datos.</b></h2>
    </header>
    <br>
    <div class="centrar">
        <a href='create_departamento.php' class="btnmen">Agregar nuevo departamento</a>
        <a href='create_codigo.php' class="btnmen">Agregar nuevo codigo</a>
        <a href='create_defecto.php' class="btnmen">Agregar nuevo defecto</a>
        <a href='create_tipo.php' class="btncat">Agregar nuevo tipo</a>
        <a href='create_estilo.php' class="btncat">Agregar nuevo estilo</a>
